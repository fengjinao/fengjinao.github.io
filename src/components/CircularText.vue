...
<template>
    ...
    }" :class="`m-0 mx-auto w-[200px] h-[200px] relative font-black text-white text-center cursor-pointer origin-center ${props.className}`"
        @mouseenter="handleHoverStart" @mouseleave="handleHoverEnd">
        <span v-for="(letter, i) in letters" :key="i"
            class="absolute inline-block text-2xl transition-all duration-500 ease-[cubic-bezier(0,0,0,1)]" :style="{
